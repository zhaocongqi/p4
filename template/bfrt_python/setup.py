...
port_match.clear()
port_match.add_with_send(ingress_port=130,port=131)
port_match.add_with_send(ingress_port=131,port=130)

send_to_ovs = p4.Ingress.send_to_ovs
send_to_ovs.reset_default
send_to_ovs.set_default_with_send(port=128)
...
print ("Table send_to_ovs:")
send_to_ovs.dump(table=True)