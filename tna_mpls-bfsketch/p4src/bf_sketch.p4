    ...
    inout my_egress_metadata_t meta)
{
    ...
    Register<bit<1>, bit<16>>(65536,0) bloomfilter1;
    Register<bit<1>, bit<16>>(65536,0) bloomfilter2;
    Register<bit<1>, bit<16>>(65536,0) bloomfilter3;
    ...
    action op_set_hash1(){
        meta.sketch_flag = set_data1.execute((bit<16>)meta.key[15:0]);
    }
    action op_get_hash1(){
        meta.sketch_flag = get_data1.execute((bit<16>)meta.key[15:0]);
    }
    action op_set_hash2(){
        meta.sketch_flag = set_data2.execute((bit<16>)meta.key[23:8]);
    }
    action op_get_hash2(){
        meta.sketch_flag = meta.sketch_flag & get_data2.execute((bit<16>)meta.key[23:8]);
    }
    action op_set_hash3(){
        meta.sketch_flag = set_data3.execute((bit<16>)meta.key[31:16]);
    }
    action op_get_hash3(){
        meta.sketch_flag = meta.sketch_flag & get_data3.execute((bit<16>)meta.key[31:16]);
    }
